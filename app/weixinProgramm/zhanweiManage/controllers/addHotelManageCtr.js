...
angular.module('app.zhanweiManage').controller('addHotelManageCtr', function ($scope,$http,AlertService,oss,Upload,$state) {
...
//    f分组获取
    ...
    $scope.submitForm = function(){
        ...
        $http.post("app/weixin/exhibitionhotel",$scope.hotel)
            .success(function(res){
                if(res.errCode==0){
